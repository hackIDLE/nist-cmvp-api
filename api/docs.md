...
- **1,156** active validated modules
- **4,277** historical modules
- **213** modules in process
- **5,433** certificate detail records
- **1,808** certificates with algorithm summaries
...
### Certificate Index
`GET api/certificates/index.json` — Compact discovery index for all 5,433 per-certificate detail files, including certificate numbers, datasets, paths, vendor/module names, statuses, standards, and algorithm counts.
...
### Active Modules
`GET api/modules.json` — All 1,156 active validated modules.
...
{
  "metadata": {
    "generated_at": "2026-08-02T05:28:12.712612Z",
    "total_modules": 1156
  },
  "modules": [
    {
      "Certificate Number": "5457",
      "Vendor Name": "Qualcomm Technologies, Inc.",
      "Module Name": "Qualcomm® Inline Crypto Engine (UFS)",
      "Module Type": "Hardware",
      "Validation Date": "07/31/2026",
      "standard": "FIPS 140-3",
      "status": "Active",
      "overall_level": 1,
      "sunset_date": "7/30/2031",
      "algorithms": [
        "AES"
      ],
      "security_policy_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5457.pdf",
      "certificate_detail_url": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5457",
      ...
      "algorithm_extraction": {
        ...
        "source": "crawl4ai",
        "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5457.pdf",
        "cached": false,
        "fallback_used": false,
        "cache_version": "2026-04-15-legacy-v1",
        "algorithm_count": 1,
        "detailed_algorithm_count": 5
      },
      "description": "Qualcomm Inline Crypto Engine (UFS) provides high throughput storage data encryption and decryption.",
...
### Historical Modules
`GET api/historical-modules.json` — All 4,277 expired or revoked modules for historical lookups.

### Modules In Process
`GET api/modules-in-process.json` — All 213 modules currently in the validation pipeline.

### Algorithms
`GET api/algorithms.json` — Algorithm usage summary across 1,808 certificates in the current build.
...
```json
{
  ...
  "total_certificate_algorithm_pairs": 16286,
  "algorithms": {
    "AES": {
      "count": 1670,
      "certificates": [
...
```json
{
  "metadata": {
    "generated_at": "2026-08-02T05:28:12.712612Z",
    "dataset": "active",
    "source": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5431"
  },
  "certificate": {
    "certificate_number": "5431",
    "dataset": "active",
    "vendor_name": "Dell Inc., BSAFE Product Team",
    "module_name": "Dell BSAFE Crypto Module for Java",
    "standard": "FIPS 140-3",
    "status": "Active",
    ...
    "sunset_date": "11/18/2029",
    "caveat": "When operated in approved mode. No assurance of the minimum strength of generated SSPs",
    "security_level_exceptions": [
      "Physical security: N/A",
      "Non-invasive security: N/A"
    ],
    "vendor": {
      "name": "Dell Inc., BSAFE Product Team",
      "website_url": "http://www.dell.com",
      "contact_email": "bsafe-fips-program@dell.com"
    },
    "related_files": [
      {
        "label": "Security Policy",
        "url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5431.pdf"
      }
    ],
    "validation_history": [
      {
    ...
    "algorithm_extraction": {
      ...
      "configured_source": "crawl4ai",
      "source": "crawl4ai",
      "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5431.pdf",
      "cached": true,
      "fallback_used": false,
      "cache_version": "2026-04-15-legacy-v1",
      "algorithm_count": 12,
      "detailed_algorithm_count": 111
    }
  }
}
```

Current build contains 5,433 certificate detail records across active and historical datasets.
...
GET api/certificates/5431.json → full detail record for that certificate
```

### Check validation status and history for a certificate
```
GET api/certificates/5431.json → status, sunset_date, validation_history, related_files
```
...
- **Algorithms coverage:** `api/algorithms.json` summarizes 1,808 certificates that had algorithm data in this build. `api/metadata.json` reports extraction cache hits, refreshes, failures, misses, and fallback counts.