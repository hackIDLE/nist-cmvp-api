...
- **1,121** active validated modules
- **4,235** historical modules
- **281** modules in process
- **5,356** certificate detail records
- **1,730** certificates with algorithm summaries
...
### Certificate Index
`GET api/certificates/index.json` — Compact discovery index for all 5,356 per-certificate detail files, including certificate numbers, datasets, paths, vendor/module names, statuses, standards, and algorithm counts.
...
### Active Modules
`GET api/modules.json` — All 1,121 active validated modules.
...
{
  "metadata": {
    "generated_at": "2026-07-07T04:16:56.074543Z",
    "total_modules": 1121
  },
  "modules": [
    {
      "Certificate Number": "5369",
      "Vendor Name": "Amazon Web Services, Inc.",
      "Module Name": "Amazon Linux 2023 Kernel Cryptographic API",
      "Module Type": "Software",
      "Validation Date": "07/06/2026",
      "standard": "FIPS 140-3",
      "status": "Active",
      "overall_level": 1,
      "sunset_date": "9/22/2029",
      "algorithms": [
        "AES",
        "DRBG",
        "ECDSA",
      ...
      "security_policy_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5369.pdf",
      "certificate_detail_url": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5369",
      ...
      "algorithm_extraction": {
        ...
        "source": "crawl4ai",
        "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5369.pdf",
        "cached": false,
        "fallback_used": false,
        "cache_version": "2026-04-15-legacy-v1",
        "algorithm_count": 8,
        "detailed_algorithm_count": 47
      },
      "description": "The Amazon Linux 2023 Kernel Cryptographic API provides cryptographic services to Linux kernel space software components and user space via the AF_ALG interf...",
...
### Historical Modules
`GET api/historical-modules.json` — All 4,235 expired or revoked modules for historical lookups.

### Modules In Process
`GET api/modules-in-process.json` — All 281 modules currently in the validation pipeline.

### Algorithms
`GET api/algorithms.json` — Algorithm usage summary across 1,730 certificates in the current build.
...
```json
{
  ...
  "total_certificate_algorithm_pairs": 15520,
  "algorithms": {
    "AES": {
      "count": 1592,
      "certificates": [
...
```json
{
  "metadata": {
    "generated_at": "2026-07-07T04:16:56.074543Z",
    "dataset": "active",
    "source": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5362"
  },
  "certificate": {
    "certificate_number": "5362",
    "dataset": "active",
    "vendor_name": "Icom Inc.",
    "module_name": "UT-125 FIPS #41,#51 and #61",
    "standard": "FIPS 140-3",
    "status": "Active",
    ...
    "vendor": {
      "name": "Icom Inc.",
      "website_url": "http://www.icomjapan.com",
      "contact_email": "MasaakiTakahashi@IcomAmerica.com"
    },
    "related_files": [
      {
        "label": "Security Policy",
        "url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5362.pdf"
      }
    ],
    "validation_history": [
      {
    ...
    "algorithm_extraction": {
      ...
      "configured_source": "crawl4ai",
      "source": "crawl4ai",
      "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5362.pdf",
      "cached": true,
      "fallback_used": false,
      "cache_version": "2026-04-15-legacy-v1",
      "algorithm_count": 6,
      "detailed_algorithm_count": 16
    }
  }
}
```

Current build contains 5,356 certificate detail records across active and historical datasets.
...
GET api/certificates/5362.json → full detail record for that certificate
```

### Check validation status and history for a certificate
```
GET api/certificates/5362.json → status, sunset_date, validation_history, related_files
```
...
- **Algorithms coverage:** `api/algorithms.json` summarizes 1,730 certificates that had algorithm data in this build. `api/metadata.json` reports extraction cache hits, refreshes, failures, misses, and fallback counts.