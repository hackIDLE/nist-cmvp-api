...
- **1,134** active validated modules
- **4,245** historical modules
- **257** modules in process
- **5,379** certificate detail records
- **1,753** certificates with algorithm summaries
...
### Certificate Index
`GET api/certificates/index.json` — Compact discovery index for all 5,379 per-certificate detail files, including certificate numbers, datasets, paths, vendor/module names, statuses, standards, and algorithm counts.
...
### Active Modules
`GET api/modules.json` — All 1,134 active validated modules.
...
{
  "metadata": {
    "generated_at": "2026-07-12T05:29:15.652683Z",
    "total_modules": 1134
  },
  "modules": [
    {
      ...
      "Module Name": "Palo Alto Networks SD-WAN Instant-On Network (ION) Devices ION 1200, ION 1200-S, ION 3200, ION 52...",
      "Module Type": "Hardware",
      "Validation Date": "07/10/2026",
      "standard": "FIPS 140-3",
      "status": "Active",
      "overall_level": 2,
      "sunset_date": "7/10/2029",
      "algorithms": [
        "AES",
        "CVL",
        "DRBG",
      ...
      "security_policy_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5393.pdf",
      "certificate_detail_url": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5393",
      ...
      "algorithm_extraction": {
        ...
        "source": "crawl4ai",
        "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5393.pdf",
        "cached": false,
        "fallback_used": false,
        "cache_version": "2026-04-15-legacy-v1",
        "algorithm_count": 11,
        "detailed_algorithm_count": 65
      },
      "description": "The Palo Alto Networks SD-WAN Instant-On Network (ION) Devices (ION 1200, ION 1200-S, ION 3200, ION 5200 and ION 9200) enable the integration of a diverse se...",
      "caveat": "When installed, initialized and configured as specified in Section 11.1 of the Security Policy. The tamper evident seals and opacity shield installed as indi..."
    }
  ]
}
```
...
### Historical Modules
`GET api/historical-modules.json` — All 4,245 expired or revoked modules for historical lookups.

### Modules In Process
`GET api/modules-in-process.json` — All 257 modules currently in the validation pipeline.

### Algorithms
`GET api/algorithms.json` — Algorithm usage summary across 1,753 certificates in the current build.
...
```json
{
  ...
  "total_certificate_algorithm_pairs": 15776,
  "algorithms": {
    "AES": {
      "count": 1615,
      "certificates": [
...
```json
{
  "metadata": {
    "generated_at": "2026-07-12T05:29:15.652683Z",
    "dataset": "active",
    "source": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5363"
  },
  "certificate": {
    "certificate_number": "5363",
    "dataset": "active",
    "vendor_name": "Ruckus Wireless LLC",
    "module_name": "RUCKUS R770-US Access Point, R770-WW Access Point, R670-US Access Point, R670-WW Access Point, T6...",
    "standard": "FIPS 140-3",
    "status": "Active",
    ...
    "vendor": {
      "name": "Ruckus Wireless LLC",
      "website_url": "http://www.commscope.com/ruckus",
      "contact_email": "jimmy.wang@ruckusnetworks.com"
    },
    "related_files": [
      {
        "label": "Security Policy",
        "url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5363.pdf"
      }
    ],
    "validation_history": [
      {
    ...
    "algorithm_extraction": {
      ...
      "configured_source": "crawl4ai",
      "source": "crawl4ai",
      "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5363.pdf",
      "cached": true,
      "fallback_used": false,
      "cache_version": "2026-04-15-legacy-v1",
      "algorithm_count": 11,
      "detailed_algorithm_count": 53
    }
  }
}
```

Current build contains 5,379 certificate detail records across active and historical datasets.
...
GET api/certificates/5363.json → full detail record for that certificate
```

### Check validation status and history for a certificate
```
GET api/certificates/5363.json → status, sunset_date, validation_history, related_files
```
...
- **Algorithms coverage:** `api/algorithms.json` summarizes 1,753 certificates that had algorithm data in this build. `api/metadata.json` reports extraction cache hits, refreshes, failures, misses, and fallback counts.