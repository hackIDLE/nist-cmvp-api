...
- **1,118** active validated modules
- **4,229** historical modules
- **281** modules in process
- **5,347** certificate detail records
- **1,721** certificates with algorithm summaries
...
### Certificate Index
`GET api/certificates/index.json` — Compact discovery index for all 5,347 per-certificate detail files, including certificate numbers, datasets, paths, vendor/module names, statuses, standards, and algorithm counts.
...
### Active Modules
`GET api/modules.json` — All 1,118 active validated modules.
...
{
  "metadata": {
    "generated_at": "2026-07-06T06:32:53.611920Z",
    "total_modules": 1118
  },
  "modules": [
    {
      ...
      "Module Name": "Defender 3000 USB Flash Drive",
      "Module Type": "Hardware",
      "Validation Date": "06/30/2026",
      "standard": "FIPS 140-3",
      "status": "Active",
      "overall_level": 3,
      ...
      "security_policy_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5364.pdf",
      "certificate_detail_url": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5364",
      ...
      "algorithm_extraction": {
        ...
        "source": "crawl4ai",
        "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5364.pdf",
        "cached": false,
        "fallback_used": false,
      ...
      "description": "The Kanguru Solutions Defender 3000 USB Flash Drive is an encrypted storage device designed as a multi-chip standalone cryptographic module. The module is de...",
...
### Historical Modules
`GET api/historical-modules.json` — All 4,229 expired or revoked modules for historical lookups.

### Modules In Process
`GET api/modules-in-process.json` — All 281 modules currently in the validation pipeline.

### Algorithms
`GET api/algorithms.json` — Algorithm usage summary across 1,721 certificates in the current build.
...
```json
{
  ...
  "total_certificate_algorithm_pairs": 15428,
  "algorithms": {
    "AES": {
      "count": 1583,
      "certificates": [
...
```json
{
  "metadata": {
    "generated_at": "2026-07-06T06:32:53.611920Z",
    "dataset": "active",
    "source": "https://csrc.nist.gov/projects/cryptographic-module-validation-program/certificate/5350"
  },
  "certificate": {
    "certificate_number": "5350",
    "dataset": "active",
    "vendor_name": "Ctrl IQ, Inc.",
    "module_name": "Rocky Linux 8 and 9 GnuTLS Cryptographic Module",
    "standard": "FIPS 140-3",
    "status": "Active",
    ...
    "vendor": {
      "name": "Ctrl IQ, Inc.",
      "website_url": "https://ciq.com/",
      "contact_email": "myoung@ciq.com"
    },
    "related_files": [
      {
        "label": "Security Policy",
        "url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5350.pdf"
      }
    ],
    "validation_history": [
      {
    ...
    "algorithm_extraction": {
      ...
      "configured_source": "crawl4ai",
      "source": "crawl4ai",
      "source_url": "https://csrc.nist.gov/CSRC/media/projects/cryptographic-module-validation-program/documents/security-policies/140sp5350.pdf",
      "cached": false,
      "fallback_used": false,
      "cache_version": "2026-04-15-legacy-v1",
      "algorithm_count": 12,
      "detailed_algorithm_count": 61
    }
  }
}
```

Current build contains 5,347 certificate detail records across active and historical datasets.
...
GET api/certificates/5350.json → full detail record for that certificate
```

### Check validation status and history for a certificate
```
GET api/certificates/5350.json → status, sunset_date, validation_history, related_files
```
...
- **Algorithms coverage:** `api/algorithms.json` summarizes 1,721 certificates that had algorithm data in this build. `api/metadata.json` reports extraction cache hits, refreshes, failures, misses, and fallback counts.